baseurl = "http://5etazki.ru/"
languageCode = "ru"
title = "Снос пятиэтажек в Москве"
theme = "grid-side-master"

# =========== GRID-THEME config part 
# Site settings (baseurl must end with a trailing slash!)
copyright = "<a href='/meta/copyright'>Copyright &#169; 5etazki.ru</a>"
...
[Params]
    ...
    [Params.Header]
        ...
        # This is optional
        name = "Снос пятиэтажек в Москве"

        # This is optional
        description = "Культовые микрорайоны, которые вы не сможете посетить. Сносят старые дома, строят новые - и привычные кварталы уже и не узнать. Мы подходим к их фотофиксации по последнему слову техники 2016 года: с ГИС-технологиями, панорамной камерой и геотегингом."

        # This is optional
        email = "***"

        # Not providing this results in a color being used
        image = "/img/header_festivalnaya35.jpg"
    ...
    [Params.Footer]
        ...
        [[Params.Footer.List]]
            ...
            icon_class = "twitter"
            icon_link = "https://twitter.com/trolleway"
        ...
        [[Params.Footer.List]]
            ...
            icon_class = "github"
            icon_link = "http://github.com/trolleway"
